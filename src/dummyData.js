const showsArray = [
...

  {
    ...
    summary:
      '<p>You are being watched. The government has a secret system, a machine that spies on you every hour of every day. I know because I built it. I designed the Machine to detect acts of terror but it sees everything. Violent crimes involving ordinary people. People like you. Crimes the government considered "irrelevant". They wouldnt act so I decided I would. But I needed a partner. Someone with the skills to intervene. Hunted by the authorities, we work in secret. Youll never find us. But victim or perpetrator, if your number is up, well find you.</p>',
  },
...
function createShowCard(obj) {
  ...
  div.innerHTML = `<div class='img-placeholder'>
    ...
    <div>
      ...
      <button class="reservation-btn" onclick='openPopup(${JSON.stringify(obj)})'>Reservations</button>
    </div>`;
